package org.jiage.srpc.server.paypal.dataobjects.expresscheckout;
    ...
    public static void main(String args[]) {
        ...
        if (Resp != null) {
            ...
            if (TrxnResponse != null) {
                ...
                System.out.println("PENDINGREASON = " + Trans.getResponse().getTransactionResponse().getPendingReason());
