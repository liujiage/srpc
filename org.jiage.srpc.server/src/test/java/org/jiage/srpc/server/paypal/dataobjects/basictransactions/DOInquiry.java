...
import org.jiage.srpc.server.paypal.UserInfoContext;
...
public class DOInquiry {
    ...
    public static void main(String args[]) {
        ...
        UserInfo user = new UserInfo(UserInfoContext.USER,
                UserInfoContext.VENDOR, UserInfoContext.PARTNER,
                UserInfoContext.PWD);
        ...
        InquiryTransaction trans = new InquiryTransaction("B30P2FD69421",
