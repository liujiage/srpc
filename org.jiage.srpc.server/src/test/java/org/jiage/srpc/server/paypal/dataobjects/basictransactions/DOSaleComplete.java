...
public class DOSaleComplete {
    ...
    public static void main(String args[]) {
        ...
        */
        ...
        inv.setInvNum("Snjeana Zlodi R�odak");
        ...
        */
        ...
        while (trxCount <= 3 && !RespRecd) {
            ...
            if (Resp != null) {
                ...
                // Refer to the Payflow Pro Developer's Guide for explanation of the items returned and for
                ...
                */
                ...
                try {
                    Thread.currentThread().sleep(5000); // let's wait 5 seconds to see if this is a temporary network issue.
