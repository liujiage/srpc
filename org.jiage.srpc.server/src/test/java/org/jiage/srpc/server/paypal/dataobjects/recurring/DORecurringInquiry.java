package org.jiage.srpc.server.paypal.dataobjects.recurring;
            ...
            if (recurResponse != null) {
                ...
                if (recurResponse.getInquiryParams().isEmpty()) {
                    ...
                    while (recurResponse.getInquiryParams().get("P_PNREF" + x) != null) {
                        ...
                        System.out.println(formati(x, 4) + " | PNREF: " + (recurResponse.getInquiryParams().get("P_PNREF" + x) +
                                " | RESULT: " + recurResponse.getInquiryParams().get("P_RESULT" + x) +
                                " | TRANSTIME: " + recurResponse.getInquiryParams().get("P_TRANSTIME" + x) +
                                " | AMOUNT: " + formatd(a, 2, 10) +
                                " | TRANSTATE: " + formati(t, 4) +
                                " | TENDER: " + recurResponse.getInquiryParams().get("P_TENDER" + x)));
                        x++;
                    }
                }
            }
